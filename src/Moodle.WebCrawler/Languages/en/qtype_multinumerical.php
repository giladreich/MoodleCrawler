...
$string['addingmultinumerical'] = 'Adding a multinumerical question';
...
$string['multinumerical_help'] = '<h2>Principe de fonctionnement</h2>
...
$string['multinumericalsummary'] = 'Allows to create a question whose correct answers may be many, governed by equations or inequations.';
