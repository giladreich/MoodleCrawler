...
/**
 * Strings for component 'turnitintool', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['deletecommentconfirm'] = 'Are you sure you want to delete this comment?nnThis can not be undone.';
...
$string['studentdeleteconfirm'] = 'Deleting this paper will allow you to make a new submission in its place.nYou will not be able to retrieve your submission once it has been deleted.nnAre you sure you want to delete this assignment?';
...
$string['synchallconfirm'] = '&#34;You are about to synchronise all submissions for this set of assignment parts with the submissions stored on Turnitin, this will pull down any submissions that were not submitted using Moodle. For large numbers of students with a large multipart assignment this can take a long time. Please do not stop the process once started.nnAre you sure you wish to proceed?';
