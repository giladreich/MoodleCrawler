...
/**
 * Strings for component 'amvonetroom', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   amvonetroom
...
$string['message_firewall_not_configured'] = 'Sorry, requested operation has been failed due to misconfiguration. You can find the most possible reasons and solutions {$a->kb_begin}here{$a->kb_end}. In the meantime please feel free to contact our {$a->support_begin}support{$a->support_end} if you need an assistance.';
