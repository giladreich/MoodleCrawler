...
/**
 * Strings for component 'enrol_guest', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_guest
...
$string['passwordinvalidhint'] = 'Falscher Gastschlüssel!<br />(Hinweis: Der Gastschlüssel beginnt mit \'{$a}\')';
