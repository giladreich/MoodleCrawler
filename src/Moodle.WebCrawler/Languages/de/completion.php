...
/**
 * Strings for component 'completion', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   completion
...
$string['completion-alt-auto-fail'] = 'Abgeschlossen (ohne Erfolg)';
$string['completion-alt-auto-n'] = 'Nicht abgeschlossen';
$string['completion-alt-auto-pass'] = 'Abgeschlossen (mit Erfolg)';
$string['completion-alt-auto-y'] = 'Abgeschlossen';
$string['completion-alt-manual-enabled'] = 'Abschluss wird manuell signalisiert';
$string['completion-alt-manual-n'] = 'Nicht abgeschlossen - mit der Auswahl als abgeschlossen markieren';
$string['completion-alt-manual-y'] = 'Abgeschlossen  - mit der Auswahl als nicht abgeschlossen markieren';
...
$string['completiononunenrolment'] = 'Abschluss bei Abmeldung';
...
$string['manualcompletionby'] = 'Manueller Abschluss von';
