...
/**
 * Strings for component 'enrol_imsenterprise', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['allowunenrol_desc'] = 'Funktion: Kurseineinschreibungen werden aufgehoben wenn dies in der IMS Enterprisedatei eingetragen ist. ';
