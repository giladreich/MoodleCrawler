...
/**
 * Strings for component 'qtype_calculated', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['editingcalculated'] = 'Berechnete Frage ändern';
