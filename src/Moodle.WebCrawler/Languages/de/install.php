...
/**
 * Strings for component 'install', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   install
...
$string['directorysettings'] = '<p>Bitte überprüfen Sie die Angaben für diese Moodle-Installation.</p>

<p><b>Web-Adresse:</b>
Geben Sie hier die vollständige Web-Adresse für Ihre Moodle-Instanz an. Sollte die Website über mehrere Adressen erreichbar sein, verwenden Sie die für Ihre Institution am einfachsten nutzbare Adresse. Beenden Sie die Web-Adresse nicht mit einem Slash.</p>

<p><b>Moodle-Verzeichnis:</b>
Geben Sie den absoluten Pfad für Ihre Moodle-Installation an. Stellen SIe sicher, dass die Groß- und Kleinschreibung korrekt ist.</p>

<p><b>Datenverzeichnis:</b>
Moodle benötigt ein Verzeichnis, in dem hochgeladene Dateien abgelegt werden. Dieses Verzeichnis muss Lese- und Schreibrechte für das Nutzerkonto besitzen, mit dem Ihr Webservers arbeitet (üblicherweise \'nobody\', \'apache\' oder \'www\'). Außerdem darf das Verzeichnis nicht direkt aus dem Internet erreichbar sein. Das Intallationsskript wird versuchen, ein solches Verzeichnis zu erstellen, falls es nicht schon existiert.</p>';
...
Geben Sie hier die vollständige Web-Adresse für Ihre Moodle-Instanz an. Sollte die Website über mehrere Adressen erreichbar sein, verwenden Sie die für Ihre Institution am einfachsten nutzbare Adresse. Beenden Sie die Web-Adresse nicht mit einem Slash.
<br />
<br />
<b>Moodle-Verzeichnis:</b>
Geben Sie den absoluten Pfad für Ihre Moodle-Installation an. Stellen SIe sicher, dass die Groß- und Kleinschreibung korrekt ist.
<br />
<br />
...
$string['gdversionhelp'] = '<p>Auf Ihrem Server scheint GD nicht installiert zu sein.</p>
<p>GD ist eine Funktionssammlung, die Moodle braucht, um Bilder zu verarbeiten (z.B. Nutzerbilder verkleinern) oder neue Bilder zu generieren (z.B. grafische Darstellung von Logdaten). Moodle kann auch ohne GD arbeiten, aber die grafischen Funktionen sind dann nicht verfügbar.</p>
<p> Um GD unter UNIX zu PHP hinzuzufügen, kompilieren Sie PHP mit dem Parameter --with-gd neu.</p>
<p>Unter Windows reicht es normalerweise, in der Datei php.ini das Kommentarzeichen für php_gd2.dll zu entfernen.</p>';
...
$string['mysqlextensionisnotpresentinphp'] = 'PHP ist nicht richtig konfiguriert, um über die PHP-Extension MySQL mit der MySQL-Datenbank zu kommunizieren. Prüfen Sie die Datei php.ini oder übersetzen Sie PHP neu.';
...
$string['odbcextensionisnotpresentinphp'] = 'PHP ist nicht richtig konfiguriert, um über die PHP-Extension ODBC mit der SQL-Datenbank zu kommunizieren. Prüfen Sie die Datei php.ini oder übersetzen Sie PHP neu.';
...
$string['phpversionhelp'] = '<p>Moodle erwartet als PHP-Version mindestens 4.3.0 oder 5.1.0 (5.0.x weist eine Reihe bekannter Fehler auf).</p>
