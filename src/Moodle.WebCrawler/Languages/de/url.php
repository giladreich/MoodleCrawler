...
/**
 * Strings for component 'url', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   url
...
$string['clicktoopen'] = 'Auf den Link \'{$a}\' klicken, um die Seite zu öffnen';
...
$string['modulename'] = 'URL/Link';
$string['modulenameplural'] = 'URLs/Links';
