...
/**
 * Strings for component 'grades', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   grades
...
$string['gradepass_help'] = '<h2>Bewertung für \'Bestehen\'</h2>
<p>Wenn die Bewertung mindestens einen bestimmten Wert erreicht haben muss oder darüber liegen soll, um zu bestehen, kann dies hier festgelegt werden.</p>';
...
$string['showuseridnumber'] = 'Nutzer-IDs anzeigen';
$string['showuseridnumber_help'] = 'Nutzer-ID in einer separaten Spalte anzeigen';
