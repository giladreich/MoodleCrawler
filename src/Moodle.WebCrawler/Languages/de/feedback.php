...
/**
 * Strings for component 'feedback', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   feedback
...
$string['modulename_help'] = 'Das Modul Feedback ermöglicht die Erstellung nutzerspezifischer Auswertungen';
