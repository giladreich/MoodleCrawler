...
/**
 * Strings for component 'glossary', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   glossary
...
$string['attachment_help'] = 'Sie dürfen optional einen oder mehrere Dateien an einen Glossareintrag anhängen.';
...
$string['modulename_help'] = 'Die Aktivität Glossar erlaubt es Teilnehmer/innen, eine Liste von Definitionen wie in einem Lexikon zu erzeugen und zu verwalten. Glossareinträge können automatisch verlinkt werden, wo immer die Begriffe oder Textpassagen im Kurs vorkommen.';
