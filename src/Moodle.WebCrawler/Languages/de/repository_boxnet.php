...
/**
 * Strings for component 'repository_boxnet', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['callbackurl'] = 'Rückmelde URL';
...
$string['information'] = 'Sie erhalten Ihren API-Key von: <a href="http://www.box.net/developers/services">Box.net Developers</a>';
$string['invalidpassword'] = 'Ungültiges Passwort';
$string['nullfilelist'] = 'Keine Dateien in diesem Repository';
$string['password'] = 'Passwort';
$string['pluginname'] = 'Box.net';
$string['pluginname_help'] = 'Dateien bei Box.net';
