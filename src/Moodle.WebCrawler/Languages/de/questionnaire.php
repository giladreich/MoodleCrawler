...
/**
 * Strings for component 'questionnaire', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['closedate'] = 'Texterläuterung';
$string['closedate_help'] = 'Sie können ein Enddatum für die Befragung angeben. Markieren Sie die Checkbox und wählen Sie ein gewünschtes Datum und die Zeit. Teilnehmer/innen können die Befragung nach diesem Zeitpunkt nicht mehr ausfüllen. Wenn die Option nicht gewählt ist, endet die Befragung nie.';
...
$string['crosstabulate'] = 'Neuen Inhalt festlegen';
...
$string['downloadtextformat_help'] = 'Erlaubt es, alle Antworten einer Befragung in einer Textdatei (CSV) zu sichern.
Diese Datei kann in eine Tabellenkalkulation (z.B. Excel oder OpenOffice Calc) oder ein Statistikprogramm zur weiteren Bearbeitung importiert werden.';
$string['dropdown'] = 'Dropdown-Feld';
$string['dropdown_help'] = 'Es gibt keinen wesentlichen Vorteil beim Einsatz des Dropdown-Feldes im Vergleich zu Radio-Buttons, ausser vielleicht dass bei längeren Optionslisten Darstellungszeilen gespart werden können (Lesbarkeit).';
...
$string['essaybox_help'] = 'Diese Frage wird ein Feld für einfachen Text anzeigen (textarea, x columns / y rows) als Angaben für Breite und Menge der Textzeilen.
...
$string['maxdigitsallowed_help'] = 'Mittels "Max. erlaubte Ziffern" können Sie die Länge und Anzahl der erforderlichen Dezimalstellen angeben.';
...
$string['opendate_help'] = 'Hier können Sie ein Datum für das Aufschalten der Befragung angeben.
Kreuzen Sie das Feld an und wählen Sie das gewünschte Datum und die Zeit.
Nutzer werden die Befragung erst nach diesem Datum ausfüllen können. Wenn diese Option nicht gewählt ist, wird die Befragung sofort zur Verfügung stehen.';
$string['option'] = 'Option {$a}';
$string['optionalname'] = 'Name der Frage';
$string['optionalname_help'] = '"Name der Frage" wird nur verwendet wenn Sie die Antworten in ein CSV/Excel-Format exportieren.
Wenn Sie keine Datenexporte machen, brauchen Sie sich nicht um "Name der Frage" zu kümmern.
Wenn Sie den Datenexport verwenden, dann haben Sie zwei Optionen für das Benennen der Fragen.';
$string['or'] = '---oder---';
...
$string['orderresponses_help'] = 'Für die Anzeige "Alle Antworten" kann die Reihenfolge nach Anzahl Antworten (Spalte Mittelwert) sortiert werden, nach folgenden 4 Fragetypen:

* Einzelauswahl (Radio Button)
* Einzelauswahl (Dropdown-Menu)
* Mehrfachauswahl (Auswahlkästchen)
* Quotenantworten (inkl. Likert-Skalen)

"Alle Antworten" wird standardmässig nach Reihenfolge der Erstellung der Fragen sortiert. Möglich ist eine aufsteigende oder absteigende Sortierung.';
...
$string['respondenteligible_help'] = 'Entscheiden Sie, ob alle Nutzer antworten können, oder ob Sie Antworten auf eine Rolle wie Tutor oder Teilnehmer/innen beschränken wollen.
Für alle beschränkenden Optionen denken Sie daran, die Rollen auf Kursebene oder Aktivitätsebene richtig zuzuordnen.
Wenn Sie z.B. eine Befragung auf der Startseite Ihres Moodle nur für Trainer/innen publizieren, werden Sie die Zuordnungen zur Rolle "Trainer/in" überprüfen wollen.';
...
$string['resume_help'] = 'Wenn diese Option gesetzt ist, dürfen Nutzer ihre Antworten zwischenspeichern bevor sie diese abgeben.
Nutzer können die Befragung unterbrechen, zwischenspeichern und später weiter machen, wo sie unterbrochen haben.';
...
$string['viewallresponses_help'] = 'Falls die Befragung auf Gruppenmodus gesetzt ist (sichtbare oder unsichtbare Gruppen) und der aktuelle Nutzer hat im aktuellen Kontext die Rechte "moodle/site:accessallgroups", und es sind Gruppen definiert im aktuellen Kontext, dann hat der Nutzer Zugang zu der Dropdown-Liste der Gruppen.
Diese Dropdown-Liste erlaubt es, die Antworten nach Gruppen zu filtern.
Falls "Getrennte Gruppen" gewählt ist, dann können Nutzer ohne entsprechende Rechte nur die Antworten "ihrer" Gruppen sehen.';
