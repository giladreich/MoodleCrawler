...
/**
 * Strings for component 'quiz_overview', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['attemptprogress'] = 'Versuch {$a->done} von {$a->todo}';
...
$string['optonlygradedattempts'] = 'Nur die Versuche der Nutzer, die bewertet werden ({$a})';
...
$string['qprogress'] = 'Frage {$a->done} von {$a->todo}';
...
$string['requiresgrading'] = 'Bewertung erforderlich';
$string['show'] = 'Einschließen';
$string['showattempts'] = 'Versuche einschließen';
