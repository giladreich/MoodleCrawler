...
/**
 * Strings for component 'auth_cas', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_certificate_check'] = 'Mit dieser Einstellung bestätigen Sie die Gültigkeit des Serverzertifikats';
...
$string['auth_cas_logoutcas'] = 'Wählen Sie für diese Einstellung "Ja", falls Sie sich vom CAS abmelden möchten, sobald Sie sich von Moodle abmelden.';
