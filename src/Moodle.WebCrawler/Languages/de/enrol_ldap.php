...
/**
 * Strings for component 'enrol_ldap', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_ldap
...
$string['role_mapping'] = '<p>Für jede Rolle, die Sie über LDAP zuweisen möchten, müssen Sie die Kontexte angeben, in denen die Kursgruppen festgelegt sind. Trennen Sie unterschiedliche Kontexte mit einem Semikolon \';\'.</p><p>Zusätzlich müssen Sie das Attribut Ihres LDAP-Servers festlegen, das für die Mitglieder einer Gruppe benutzt wird, normalerweise \'member\' or \'memberUid\'</p>';
