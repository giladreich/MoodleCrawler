...
/**
 * Strings for component 'lesson', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   lesson
...
$string['gotoendoflesson'] = 'Zum Lektionsende gehen';
...
$string['minimumnumberofquestions_help'] = 'Dieser Wert legt die minimale Anzahl von Fragen fest, die in die Bewertung der Aktivität eingehen. Falls die Lektion mindestens eine Inhaltsseite enthält, sollte der Wert auf 0 gesetzt werden.

Wenn Sie den Wert auf 20 setzen, so wird eine entsprechende Ankündigung zu Beginn der Lektion empfohlen, beispielsweise so: "In dieser Lektion wird von Ihnen erwartet, dass Sie mindestens 20 Fragen bearbeiten.  Wenn Sie möchten, dürfen Sie auch mehr Fragen versuchen. Falls Sie allerdings weniger als 20 Fragen bearbeiten, wird Ihrer Bewertung trotzdem von 20 versuchten Fragen ausgegangen."';
...
$string['modulename_help'] = 'Die Aktivität \'Lektion\' ermöglicht es, Lerninhalte auf eine flexible Weise zu präsentieren. Eine Lektion besteht aus einer Serie von Seiten, die Informationen und Fragen enthalten. Die Navigation kann linear oder beliebig komplex erfolgen.';
