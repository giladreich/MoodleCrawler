...
/**
 * Strings for component 'block_online_users', language 'de', branch 'MOODLE_20_STABLE'
 *
...
$string['configtimetosee'] = 'Nach dieser Zeit (in Minuten) werden inaktive Personen aus dem Block \'Online-Aktivitäten\' entfernt.';
