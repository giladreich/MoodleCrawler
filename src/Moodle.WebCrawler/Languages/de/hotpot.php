...
/**
 * Strings for component 'hotpot', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   hotpot
...
** Ja **
: Es wird eine Endseite angezeigt, wenn das HotPot abgeschlossen ist. Der Inhalt der Endseite wird durch die Einstellungen für Text, Feedback und Links bestimmt.

** Nein **
: Es wird keine Endseite angezeigt, wenn das HotPot abgeschlossen ist. Stattdessen wird sofort automatisch zur nächsten Aktivität oder auf die Kursseite weitergeleitet.';
...
* Webseite - die URL einer Webseite ist notwendig, z.B. http://www.meinserver.de/feedbackform.html
* Feedback-Formular - die URL zu einem Scriptformular ist notwendig, z.B. http://www.meinserver.de/cgi-bin/feedback.pl
* Moodle-Forum - der Forumsindex des Kurses wird angezeigt
* Moodle-Messaging - das Fenster für das Moodle-Messaging wird angezeigt. Wenn der Kurs mehrere Trainer/innen hat, müssen die Teilnehmer/innen auswählen, für wen sie das Messaging-Fenster öffnen möchten.';
