...
/**
 * Strings for component 'tag', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   tag
...
$string['deletedcoursetags'] = 'Kursschlagworte gelöscht';
...
$string['seeallblogs'] = 'Blogeinträge mit dem Schlagwort "{$a}" anzeigen...';
